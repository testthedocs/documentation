...
project = u'Jarvis'
copyright = u'2017-2018 TestTheDocs'
author = u'TestTheDocs'
...
html_title = u'Jarvis Documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Jarvis'

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = '_static/jarvis.svg'
...
html_static_path = ['_static', 'myscript.js']
# Do not show source link
